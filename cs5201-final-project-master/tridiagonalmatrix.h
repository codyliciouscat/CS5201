 ...
 * @brief Header file for TridiagonalMatrix class
 * @date 2019-04-13
 */
...
class TridiagonalMatrix : public AbstractMatrix< T >
{
    ...
    public:
         ...
         */
        TridiagonalMatrix( const TridiagonalMatrix< T > & source );
         ...
         */
        TridiagonalMatrix( const DiagonalMatrix< T > & source );
         ...
         */
        TridiagonalMatrix< T > & operator=( const TridiagonalMatrix< T > & source );
         ...
         * @throws Error< SIZE_MISMATCH_ERROR > if precondition is not met
         */
        TridiagonalMatrix< T > & operator+=( const DiagonalMatrix< T > & rhs );
         ...
         */
        TridiagonalMatrix< T > operator*( const double scalar ) const;
         ...
         * @return Reference to calling matrix
         */
        TridiagonalMatrix< T > & operator*=( const double scalar );
